...
fwd_5_20 = f_fwd_rate(t1 = 5./360., t2 = 20./360., rf = Market$rf)
fwd_5_40 = f_fwd_rate(t1 = 5./360., t2 = 40./360., rf = Market$rf)
...
tmp_biv = rmnorm(n = 5 * n_sim, mean = M1$mu, varcov = M1$Sigma)
...
PL_ststgauss2D = exp(-r5) * BV_5d - V0
...
PL_gauss_volsurf = exp(-r5) * BV_new - V0
...
for(i in 1:5){
  ...
  logrets_vix = as.numeric(fit_vix$coef["intercept"]) +
    as.numeric(fit_vix$coef["ar1"]) * logrets_vix  +
